...
//
// Description : Configuration file for Estitofo_TCPDF.
...
/**
 * Configuration file for Estitofo_TCPDF.
 * @author Nicola Asuni
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Estitofo_TCPDF');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Estitofo_TCPDF');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Estitofo_TCPDF Example');
...
/**
 * If true allows to call Estitofo_TCPDF methods using HTML syntax
 * IMPORTANT: For security reason, disable this feature if you are printing user HTML content.
 */
define('K_TCPDF_CALLS_IN_HTML', false);

/**
 * List of Estitofo_TCPDF methods that are allowed to be called using HTML syntax.
