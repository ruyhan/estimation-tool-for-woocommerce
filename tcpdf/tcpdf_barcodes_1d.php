...
class TCPDFBarcode {
	...
	protected function encode_code39_ext($code) {
		$encode = array(
			...
			chr(8) => '$H', chr(9) => '$I', chr(10) => '$J', chr(11) => 'Ã‚Â£K',
	...
	protected function barcode_code93($code) {
		...
		$encode = array(
			...
			chr(8) => chr(128).'H', chr(9) => chr(128).'I', chr(10) => chr(128).'J', chr(11) => 'Ã‚Â£K',
	 ...
	 * The fields are described as follows:<ul><li>The Barcode Identifier shall be assigned by USPS to encode the presort identification that is currently printed in human readable form on the optional endorsement line (OEL) as well as for future USPS use. This shall be two digits, with the second digit in the range of 0Ã¢â‚¬â€œ4. The allowable encoding ranges shall be 00Ã¢â‚¬â€œ04, 10Ã¢â‚¬â€œ14, 20Ã¢â‚¬â€œ24, 30Ã¢â‚¬â€œ34, 40Ã¢â‚¬â€œ44, 50Ã¢â‚¬â€œ54, 60Ã¢â‚¬â€œ64, 70Ã¢â‚¬â€œ74, 80Ã¢â‚¬â€œ84, and 90Ã¢â‚¬â€œ94.</li><li>The Service Type Identifier shall be assigned by USPS for any combination of services requested on the mailpiece. The allowable encoding range shall be 000http://it2.php.net/manual/en/function.dechex.phpÃ¢â‚¬â€œ999. Each 3-digit value shall correspond to a particular mail class with a particular combination of service(s). Each service program, such as OneCode Confirm and OneCode ACS, shall provide the list of Service Type Identifier values.</li><li>The Mailer or Customer Identifier shall be assigned by USPS as a unique, 6 or 9 digit number that identifies a business entity. The allowable encoding range for the 6 digit Mailer ID shall be 000000- 899999, while the allowable encoding range for the 9 digit Mailer ID shall be 900000000-999999999.</li><li>The Serial or Sequence Number shall be assigned by the mailer for uniquely identifying and tracking mailpieces. The allowable encoding range shall be 000000000Ã¢â‚¬â€œ999999999 when used with a 6 digit Mailer ID and 000000-999999 when used with a 9 digit Mailer ID. e. The Delivery Point ZIP Code shall be assigned by the mailer for routing the mailpiece. This shall replace POSTNET for routing the mailpiece to its final delivery point. The length may be 0, 5, 9, or 11 digits. The allowable encoding ranges shall be no ZIP Code, 00000Ã¢â‚¬â€œ99999,  000000000Ã¢â‚¬â€œ999999999, and 00000000000Ã¢â‚¬â€œ99999999999.</li></ul>
